object FrmTransporteDespesasFixas: TFrmTransporteDespesasFixas
  Left = 0
  Top = 0
  Caption = 'Transporte Fixa'
  ClientHeight = 365
  ClientWidth = 300
  Color = clBtnFace
  ...
  object pnlFundo: TPanel
    ...
    object pnlAlimentacaoExtra: TPanel
      ...
      DesignSize = (
        298
        363)
      object lbDataHoraTransporteFixa: TLabel
        Left = 34
        Top = 204
        Width = 91
        Height = 23
      ...
      object lbValorTransporteFixa: TLabel
        Left = 34
        Top = 113
        Width = 40
        Height = 23
      ...
      object lbInserirTransporteFixa: TLabel
        Left = 113
        Top = 305
        Width = 53
        Height = 26
      ...
      object edDataHoraTransporteFixa: TEdit
        Left = 34
        Top = 233
        Width = 206
        Height = 25
      ...
      object edValorTransporteFixa: TEdit
        Left = 34
        Top = 142
        Width = 207
        Height = 25
