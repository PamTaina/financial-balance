object FrmMoradiaDespesasFixas: TFrmMoradiaDespesasFixas
  Left = 0
  Top = 0
  Caption = 'Moradia Fixa'
  ClientHeight = 368
  ClientWidth = 288
  Color = clBtnFace
  ...
  object pnlFundo: TPanel
    ...
    object pnlAlimentacaoExtra: TPanel
      ...
      DesignSize = (
        286
        366)
      object lbDataHoraMoradiaFixa: TLabel
        Left = 35
        Top = 204
        Width = 91
        Height = 23
      ...
      object lbValorMoradiaFixa: TLabel
        Left = 34
        Top = 113
        Width = 40
        Height = 23
      ...
      object lbInserirMoradiaFixa: TLabel
        Left = 113
        Top = 305
        Width = 53
        Height = 26
      ...
      object edDataHoraMoradiaFixa: TEdit
        Left = 34
        Top = 233
        Width = 206
        Height = 25
      ...
      object edValorMoradiaFixa: TEdit
        Left = 34
        Top = 142
        Width = 207
        Height = 25
      ...
      object pnlCabecalhoPaginaInicial: TPanel
        ...
        object FrmMoradiaDespesasFixas: TImage
          Left = 17
          Top = 16
          Width = 33
          Height = 33
