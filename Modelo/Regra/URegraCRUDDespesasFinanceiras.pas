unit URegraCRUDDespesasFinanceiras;
...
type
  TRegraCRUDDespesasFinanceiras = class(TRegraCRUD)
  protected
...
constructor TRegraCRUDDespesasFinanceiras.Create;
begin
  inherited;
  FRepositorioDB := TRepositorioDB<TENTIDADE>(TRepositorioDespesasFinanceiras.Create);
end;

procedure TRegraCRUDDespesasFinanceiras.PreparaAtualizacao(const coENTIDADE: TENTIDADE);
begin
  inherited;
...
procedure TRegraCRUDDespesasFinanceiras.PreparaInsercao(const coENTIDADE: TENTIDADE);
begin
  inherited;
  with TUSUARIO(coENTIDADE) do
  begin
...
procedure TRegraCRUDDespesasFinanceiras.ValidaAtualizacao(const coENTIDADE: TENTIDADE);
begin
  inherited;
  with TUSUARIO(coENTIDADE) do
  begin
...
procedure TRegraCRUDDespesasFinanceiras.ValidaInsercao(const coENTIDADE: TENTIDADE);
begin
  inherited;
  with TUSUARIO(coENTIDADE) do
  begin
...
procedure TRegraCRUDDespesasFinanceiras.ValidaSenha(const csSenha, csConfimacaoSenha: String);
begin
